...
export class Program {
  ...
  constructor(gl, {
    ...
    if (vs === undefined || fs === undefined &&
      ...
      assert(false, "vs, fs has to be provided!");
    }
    ...
    this.userData = {};
    this.transformFeedbackHandle = null;
    Object.seal(this);
  }
  ...
  _compileAndLink() {
    ...
    if (this.transformFeedbackVaryings) {
      gl.transformFeedbackVaryings(this.handle, this.transformFeedbackVaryings, gl.SEPARATE_ATTRIBS);
    }
    gl.linkProgram(this.handle);
    gl.detachShader(this.handle, this.vs.handle);
    gl.detachShader(this.handle, this.fs.handle);
